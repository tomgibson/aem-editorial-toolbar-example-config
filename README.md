...
Install the extension, then open this URL in Chrome:

https://raw.githubusercontent.com/tomgibson/aem-editorial-toolbar-example-config/main/acme.aem-toolbar.json
...
| File | What it is |
|---|---|
| `acme.aem-toolbar.json` | The manifest. Names the package and points at the four config files |
...
The extension itself is at [tomgibson/aem-editorial-toolbar](https://github.com/tomgibson/aem-editorial-toolbar).
